...
export default function DropdownsMenu({ menu }) {
    ...
    return (
        <div className="lg:relative group lg:flex lg:justify-center lg:flex-row"
            ...
            <div className={`bg-zinc-800 lg:absolute lg:border-[1px] lg:border-white lg:top-20 group-hover:block lg:z-20 lg:rounded-md` + (isVisible ? " block" : " hidden")}>
                {menu.links.map(link =>
