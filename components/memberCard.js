...
function MemberCard({ id, img, name, title}) {
    ...
    return (
        ...
        <div onClick={() => router.push(`/members/${id}`)} className="cursor-pointer w-[300px] xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5 mr-3">
