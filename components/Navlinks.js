    ...
    return (
        <div className={`w-full h-screen flex-1 border-t border-white lg:w-auto lg:h-16 lg:block lg:pt-0 lg:border-0 ` + (isVisible ? " visible" : " hidden")}>
            <div className="justify-end flex-1 items-center text-white lg:flex lg:h-16 lg:m-0">
                ...
                <DropdownsMenu menu={{
                    header: "Faliyetlerimiz",
                    links: [
                        { uri: "/teknoloji", text: "Teknoloji Takımları" },
                ...
                <div>
                    <Link href="/duyurular"><a className="flex items-center h-10 pl-3 lg:px-4 lg:mx-4 lg:bg-inherit lg:h-20 hover:bg-zinc-800 lg:text-lg">Duyurular</a></Link>
                </div>
                <div>
                    <Link href="/iletisim"><a className="flex items-center h-10 pl-3 lg:px-4 lg:mx-4 lg:bg-inherit lg:h-20 hover:bg-zinc-800 lg:text-lg" href="/hakkimizda">İletişim</a></Link>
                </div>
            </div>
        </div>
    );
